...
public class HttpsClient implements java.io.Serializable {
	 ...
	 * @throws WeixinException 微信操作异常
	 */
	public Response postXml(String url, String xml, String partnerId, String certPath, String certSecret)
	 ...
	 * @throws WeixinException 微信操作异常
	 */
	private Response httpsRequest(String url, String method, String postData, boolean needCert, String partnerId,
			String certPath, String certSecret) throws WeixinException {
		Response res = null;
		OutputStream output;
	...
	private void setHttpsHeader(HttpsURLConnection httpsUrlConnection, String method, boolean needCert,
			String partnerId, String certPath, String certSecret)
